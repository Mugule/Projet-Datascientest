...
# URL de la page des évaluations de Zelda Breath of the Wild sur Amazon France
url_template = "https://www.amazon.fr/Legend-Zelda-Breath-Wild/product-reviews/B01N1083WZ/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber={page_num}"
...
df.to_csv("AMAZON SA BOTW 3.csv", index=False)
